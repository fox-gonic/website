...
<CardGrid stagger>
  <Card title="🚀 Automatic Parameter Binding">
...
func main() {
    ...
    r.POST("/user", func(_ *fox.Context, req *UserRequest) (any, error) {
